...
################################################electronParticleNet#####################
pnetElectronVariables = cms.EDProducer("ElectronTagInfoCollectionProducer",
        src = cms.InputTag("linkedObjects","electrons"),
...
electronPN = cms.EDProducer('ElectronPNETProducer',
                        ...
                        flav_names = cms.vstring(["prompt","heavy","light","tau"]),
)
...
electronTable = simplePATElectronFlatTableProducer.clone(
    ...
    externalVariables = cms.PSet(
        ...
        pnScore_heavy = ExtVar(cms.InputTag("electronPN:heavy"), float, doc="ParticleNet score for heavy-flavor electron", precision=14),
        pnScore_light = ExtVar(cms.InputTag("electronPN:light"), float, doc="ParticleNet score for light-flavor electron", precision=14),
        pnScore_prompt = ExtVar(cms.InputTag("electronPN:prompt"), float, doc="ParticleNet score for prompt electron", precision=14),
        pnScore_tau = ExtVar(cms.InputTag("electronPN:tau"), float, doc="ParticleNet score for tau-fake electron", precision=14),
...
electronTask = cms.Task(bitmapVIDForEle,bitmapVIDForEleFall17V2,bitmapVIDForEleHEEP,isoForEle,isoForEleFall17V2,ptRatioRelForEle,seedGainEle,calibratedPatElectronsNano,slimmedElectronsWithUserData,finalElectrons, pnetElectronVariables, electronPN)
